...
#define Pi 3.1415926
#define pulley_diameter 4.3942
#define rod_length 520
...
//   uint8_t steps = (uint8_t)(ref_angle*rod_length/(pulley_diameter/2));
//   if (steps>maximum_steps) steps = maximum_steps;
//   return steps;
// }
